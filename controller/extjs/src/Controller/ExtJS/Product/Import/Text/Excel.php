	...
	implements Controller_ExtJS_Common_Load_Text_Interface
{
	...
	public function uploadFile( stdClass $params )
	{
		...
		$dir = $config->get( 'controller/extjs/product/import/text/excel/uploaddir', 'uploads' );


		if( $config->get( 'controller/extjs/product/import/text/excel/enablecheck', true ) ) {
		...
		$perms = $config->get( 'controller/extjs/product/import/text/excel/fileperms', 0660 );
