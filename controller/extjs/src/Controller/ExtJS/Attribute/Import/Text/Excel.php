 ...
 * @subpackage ExtJS
 */
class Controller_ExtJS_Attribute_Import_Text_Excel
	extends Controller_ExtJS_Attribute_Import_Text_Default
	implements Controller_ExtJS_Common_Load_Text_Interface
{
	...
	public function uploadFile( stdClass $params )
	{
		...
		$dir = $config->get( 'controller/extjs/attribute/import/text/excel/uploaddir', 'uploads' );

		if( $config->get( 'controller/extjs/attribute/import/text/excel/enablecheck', true ) ) {
		...
		$perms = $config->get( 'controller/extjs/attribute/import/text/excel/fileperms', 0660 );
