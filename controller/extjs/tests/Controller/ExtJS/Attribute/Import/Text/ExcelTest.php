...
class Controller_ExtJS_Attribute_Import_Text_ExcelTest extends MW_Unittest_Testcase
{
	...
	public static function main()
	{
		...
		$suite  = new PHPUnit_Framework_TestSuite( 'Controller_ExtJS_Attribute_Import_Text_ExcelTest' );
	...
	protected function setUp()
	{
		...
		$this->_object = new Controller_ExtJS_Attribute_Import_Text_Excel( $context );
	}
